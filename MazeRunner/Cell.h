...
public:
    ...
    bool has_top_wall() const 
    { 
        return top;
    }
    bool has_bottom_wall() const 
    {
        return bottom; 
    }
    bool has_left_wall() const 
    {
        return left;
    }
    bool has_right_wall() const 
    {
        return right;
    }
    void vist_not() 
    {
        puts(is_visited ? "visited" : "not visited");
    }
